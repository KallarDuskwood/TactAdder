...
namespace TACT.Net.Root
{
    ...
    public class RootFile 
    {
        ...
        public void AddOrUpdate(CASRecord record, TACTRepo tactRepo = null, LocaleFlags LocaleFlag = LocaleFlags.All_WoW)
        {
            if (FileLookup == null)
            ...
            AddOrUpdate(rootRecord, LocaleFlag);
        ...
        public void AddOrUpdate(RootRecord rootRecord, LocaleFlags LocaleFlag = LocaleFlags.All_WoW)
        {
            ...
            if (blocks.Count() == 0)
                AddBlock(LocaleFlag, ContentFlags);
